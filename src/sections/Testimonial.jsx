...
const ReviewCard = ({ img, name, username, body }) => {
  return (
    <figure
      className={twMerge(
        "relative h-full w-64 cursor-pointer overflow-hidden rounded-xl border p-4 m-1 border-gray-50/10 bg-linear-to-r bg-indigo to-storm hover:bg-royal hover-animation",
      )}
    >
